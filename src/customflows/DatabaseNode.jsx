...
const DatabaseNode = ({ data }) => {
    ...
    const fields = [
        { label: 'Database URL', name: 'dbUrl', type: 'text', required: true },
        { label: 'Username', name: 'dbUsername', type: 'text', required: true },
        { label: 'Password', name: 'dbPassword', type: 'password', required: true },
        { label: 'Database Name', name: 'dbName', type: 'text', required: false },
        { label: 'Port', name: 'dbPort', type: 'text', required: false },
    ];
